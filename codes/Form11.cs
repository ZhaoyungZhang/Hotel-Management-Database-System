...
namespace 酒店后台管理应用
{
    public partial class rzdjform : Form
    {
        ...
        private void rzdjform_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("输入手机号不是11位,请重新输入！", "警告信息", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            if (DC.Read())//客户不是首次入住
            {
                MessageBox.Show("欢迎顾客光临，继续办理入住业务！");
                //跳转到 选择房
                ...
                if (d4.Read())
                {
                    ...
                    Form24 form24 = new Form24(clientID);
                    form24.ShowDialog();
            ...
            else //客户不存在的时候
            {
                ...
                {
                    MessageBox.Show("顾客首次入住，已自动办理为会员！");
        ...
        private void rzdjform_FormClosing(object sender, FormClosingEventArgs e)
        {

        }

        private void rzdjform_FormClosed(object sender, FormClosedEventArgs e)
        {
